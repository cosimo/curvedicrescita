# $Id: ModifyUser.pm,v 1.2 2007/06/05 21:55:15 cosimo Exp $

package Opera::FormValidator::ModifyUser;
use strict;
use base q(Opera::FormValidator::NewUser);
...
Opera::FormValidator::ModifyUser - User modify form field validation routines
