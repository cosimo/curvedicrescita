...
use Opera::Application::Articles;
use Opera::Application::Auth;
use Opera::Application::Users;
...
sub setup
{
    ...
    $self->run_modes(
        # "default" runmode handles template-only pages with no logic
        homepage        => \&default,
        help            => \&default,
...
sub default_error
{
    ...
    $self->log('error', 'There was a critical error!');
...
{
    my $self = $_[0];
    my $ses_tbl = Opera::File::Sessions->new();
    ...
    $self->session_config(
        ...
        CGI_SESSION_OPTIONS => [ "driver:mysql;serializer:Storable", $self->query, {Handle=>$ses_tbl->dbh} ],
