...
function getTimelineData(f) {
    ...
    var timeline_data = {
        ...
        "events" : [
            ...
            "url" : "http://www.curvedicrescita.com/exec/article/2009/03/12/meravigliosi-nove-mesi-primo-trimestre",
            "durationEvent" : false },
            ...
            "end": plusWeeks(um,12), //"2010-04-06",
            "title": "Villocentesi",
            "description": "La villocentesi (opzionale) è una tecnica invasiva di diagnosi prenatale che presenta il rischio di indurre aborto nell'1% dei casi. Consiste nell’aspirazione di una piccola quantità di tessuto coriale (10-15 mg). http://www.curvedicrescita.com/exec/article/2009/02/10/valutazione-translucenza-nucale ",
            "color" : "#ff0000",
            "textColor" : "#000000",
            "durationEvent" : true },
            ...
            "title": "Ecofalda",
            "description": "Si tratta di valutare la quantità e la qualità del liquido amniotico, poichè la sua diminuzione è il più importante segnale di una sofferenza fetale.",
            "color" : "#ffcc00",
            "textColor" : "#000000",
            "durationEvent" : true },
